...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'URL.shtml'
        db.alter_column(u'ssiexport_url', 'shtml', self.gf('django.db.models.fields.files.FileField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'URL.shtml'
        db.alter_column(u'ssiexport_url', 'shtml', self.gf('django.db.models.fields.files.FileField')(max_length=100))
