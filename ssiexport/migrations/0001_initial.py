...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ssiexport_queryset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ssiexport.URL'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('bson_data', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'ssiexport', ['Queryset'])
        ...
        db.create_table(u'ssiexport_url', (
            ...
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='instance_url_set', null=True, to=orm['ssiexport.Instance'])),
            ('shtml', self.gf('django.db.models.fields.files.FileField')(max_length=1024)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'ssiexport_queryset')
    ...
    models = {
        ...
        u'ssiexport.include': {
            'Meta': {'ordering': "('url', 'template')", 'object_name': 'Include'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'ssiexport.instance': {
            'Meta': {'ordering': "('id',)", 'unique_together': "(('object_id', 'content_type'),)", 'object_name': 'Instance'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'ssiexport.queryset': {
            'Meta': {'object_name': 'Queryset'},
            'bson_data': ('django.db.models.fields.TextField', [], {}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'url': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ssiexport.URL']"})
        },
        ...
        u'ssiexport.url': {
            'Meta': {'ordering': "('path',)", 'object_name': 'URL'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'shtml': ('django.db.models.fields.files.FileField', [], {'max_length': '1024'}),
