...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'URL.shtml'
        db.add_column(u'ssiexport_url', 'shtml',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'URL.shtml'
        db.delete_column(u'ssiexport_url', 'shtml')
    ...
    models = {
        ...
        u'ssiexport.url': {
            ...
            'shtml': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
